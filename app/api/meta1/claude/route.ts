...
const META1_FACT_CHECK_INSTRUCTION =
  "추가 규칙: 사실 확인을 꼭 하세요. 쉬운 표현이나 다른 말로 설명한 것은 허용하되, 지구의 자전·공전, 달의 운동, 낮과 밤, 계절 변화, 태양계와 우주에 대한 과학적 사실 오류는 그냥 넘기지 말고 해당 항목 rating을 낮추며 improve에 바로잡을 내용을 포함하세요. PDF에 지구와 우주 관련 구체적인 천체, 현상, 수치, 개념이 나오면 web_search 도구로 신뢰할 수 있는 자료를 찾아 대조하세요. 사실 오류를 발견하면 improve의 첫머리를 '사실 확인:'으로 시작하고, 잘못된 내용과 바르게 고칠 내용을 초등학생이 이해할 수 있게 구체적으로 적으세요. 확실하지 않은 내용은 단정하지 말고 자료로 다시 확인하라고 안내하세요.";
